...
| Application duplex | **Not SI.** Offer / accept / frame are user-PGP Chat gossip; host listen is existing `mining` + `listenKind: "chat"`. Spec: [Duplex overlay](../l0/duplex-forward.md) |
