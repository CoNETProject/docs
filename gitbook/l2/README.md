...
8. [Lab honesty track](lab-honesty-track.md) — 2026-08-17 MVP review; P12–P24 engine; P23 keep-deploy 6/7 + 409→accept; P24 isolated `node.ts` gate; P25 Explorer overlays landed + public SPA `index-DaEv6psZ.js`
